...
public class PropertyRead {
	...
	private static Logger _log = Logger.getLogger(PropertyRead.class);
	...
	private static Properties loadPropertyFile(String propertyFilePath) {
		java.io.InputStream is = PropertyRead.class
	...
	public final static boolean setValueAndStore(String propertyFilePath,
		...
		try {
			...
			String path = PropertyRead.class.getResource(propertyFilePath)
					.getPath();
	...
	public static void main(String[] args) {
		...
		String v = PropertyRead.getValue(path, "jdbc.driverClassName");
		_log.info("value0 = " + v);

		Hashtable<String, String> ht = new Hashtable<String, String>();
		ht.put("name", "dengcd");
		PropertyRead.setValueAndStore(path, ht);
		String v_ = PropertyRead.getValue(path, "name");
		_log.info("value1 = " + v_);
		PropertyRead.reloadPropertyFile(path);
		String v2_ = PropertyRead.getValue(path, "name");
